...
def main(image, original):
    ...
    # rescale2 --------------------------------
    scaled_image = rescale2(gray_image)
    original_scale = rescale2(original)
    original = original_scale
    ...
    border_size = 10
    bordered = cv2.copyMakeBorder(scaled_image, border_size, border_size, border_size, border_size, cv2.BORDER_CONSTANT, value=255)
    ...
    output_filename = '1000-receipt-edged.jpg'
